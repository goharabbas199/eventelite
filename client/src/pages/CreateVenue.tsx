              ...
              >
                ...
                <div>
                  ...
                  <div
                    ...
                    className="border-2 border-dashed rounded-xl p-8 text-center bg-slate-50 dark:bg-zinc-800/40 hover:bg-slate-100 dark:hover:bg-zinc-800/60 transition cursor-pointer"
                  >
