  ...
  return (
    <Layout title="Client Profile">
      ...
      <div className="space-y-4">
        ...
        {/* Profile card */}
        <div className="bg-white dark:bg-zinc-900/60 rounded-2xl shadow-sm border border-slate-100 dark:border-zinc-800 p-4 md:p-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {[
          { label: "Budget",           value: `$${budget.toLocaleString()}`,             cls: "text-slate-800 dark:text-zinc-100" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <Card className="border border-slate-100 dark:border-zinc-800 shadow-sm">
            ...
            <CardContent className="p-0">
              ...
              <Table>
                ...
                <TableBody>
                  {selectedVenue && (
                    <TableRow className="bg-slate-50 dark:bg-zinc-800/30">
                      <TableCell className="font-semibold text-slate-700 dark:text-zinc-300 pl-6">
                  ...
                  {client.services?.map((service: any) => (
                    <TableRow key={service.id}>
                      ...
                      <TableCell className="font-medium text-slate-800 dark:text-zinc-100">
                  ...
                  {totalCost > 0 && (
                    <TableRow className="bg-blue-50 dark:bg-blue-950/30 font-semibold border-t-2 dark:border-zinc-700">
                ...
                <Table>
                  ...
                  <TableBody>
                    {client.payments.map((p: any) => (
                      <TableRow key={p.id}>
                        <TableCell className="pl-6 text-slate-600 dark:text-zinc-400">
                          {format(new Date(p.paymentDate), "MMM dd, yyyy")}
                        </TableCell>
                        <TableCell className="font-semibold text-emerald-600">
                          ${Number(p.amount).toLocaleString()}
                        </TableCell>
                        <TableCell className="text-slate-500 dark:text-zinc-400">{p.paymentMethod}</TableCell>
                        <TableCell className="text-slate-500 dark:text-zinc-400">{p.notes || "-"}</TableCell>
                        <TableCell className="text-right pr-6">
                          <button
        ...
        <div className="flex flex-col gap-4">
          <Card className="border border-slate-100 dark:border-zinc-800 shadow-sm bg-white dark:bg-zinc-900/60">
            <CardHeader>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500 dark:text-zinc-400">Client Budget</span>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500 dark:text-zinc-400">Gross Profit</span>
                    <div className="text-right">
                      ...
                      <div className="text-xs text-slate-400 dark:text-zinc-500">{profitPercentage}% margin</div>
                    </div>
                  </div>
                </div>
      ...
      <CardContent className="pt-4">
        <div className="space-y-4">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold text-slate-800 dark:text-zinc-100">${totalCost.toLocaleString()}</span>
          </div>

          {/* Markup input */}
          <div>
            <label className="text-xs font-semibold text-slate-600 dark:text-zinc-400 block mb-1.5">
              Markup Percentage
            </label>
            <div className="flex items-center gap-3">
              ...
              />
              <div className="flex items-center gap-1 border border-slate-200 dark:border-zinc-700 rounded-lg px-2.5 py-1 bg-slate-50 dark:bg-zinc-800 min-w-[60px] justify-center">
                <Input
                  type="number"
                  min={0}
                  max={200}
          ...
          <div className="border-t dark:border-zinc-800 pt-4 space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-500 dark:text-zinc-400">Suggested Price</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-500 dark:text-zinc-400">Expected Profit</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-500 dark:text-zinc-400">Profit Margin</span>
