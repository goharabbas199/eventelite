...
function ServiceRow({
  ...
  return (
    <React.Fragment>
      <TableRow className="hover:bg-slate-50/60 dark:hover:bg-zinc-800/30 transition-colors duration-150">
        <TableCell className="pl-6 py-4">
          <div className="flex flex-col gap-0.5">
            <span className="font-semibold text-slate-700 dark:text-zinc-200 text-sm leading-snug">
              {service.serviceName}
            </span>
            {vendor && (
        ...
        <TableCell className="py-4 font-semibold text-slate-800 dark:text-zinc-100 text-sm tabular-nums">
          ${Number(service.cost).toLocaleString()}
        </TableCell>
        <TableCell className="py-4 text-sm text-slate-400 dark:text-zinc-500 max-w-[200px]">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-md border transition-all duration-150 ${
                  isExpanded
                    ...
                    : "bg-slate-50 dark:bg-zinc-800/60 border-slate-200 dark:border-zinc-700 text-slate-500 dark:text-zinc-400 hover:border-indigo-300 dark:hover:border-indigo-500/40 hover:text-indigo-600 dark:hover:text-indigo-400"
                }`}
              >
  ...
  return (
    <Layout title="Client Profile">
      <div className="space-y-5">
        ...
        {/* ── Profile card ── */}
        <div className="bg-white dark:bg-zinc-800/80 rounded-2xl shadow-sm border border-slate-100 dark:border-zinc-700 p-4 md:p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            { label: "Budget",         value: `$${budget.toLocaleString()}`,                   cls: "text-slate-800 dark:text-zinc-200" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <Card className="border border-slate-100 dark:border-zinc-700 shadow-sm">
              <CardHeader className="border-b border-slate-100 dark:border-zinc-700 pb-3">
                ...
                {taskList.filter((t) => !t.serviceId).length === 0 ? (
                  ...
                  <ul className="divide-y divide-slate-100 dark:divide-zinc-800">
                    {taskList.filter((t) => !t.serviceId).map((task) => (
                      <li
                        key={task.id}
                        className="flex items-center gap-3 px-5 py-3 hover:bg-slate-50/80 dark:hover:bg-zinc-700/20 transition-colors group"
                      >
                        <button
                          onClick={() =>
                            updateTask.mutate({
            ...
            {/* Planned Services */}
                <Card className="border border-slate-100 dark:border-zinc-700 shadow-sm">
                  <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 dark:border-zinc-700 pb-3">
                  ...
                  <CardContent className="p-0">
                    <div className="overflow-x-auto">
                      <Table>
                        <TableHeader>
                          <TableRow className="border-b border-slate-100 dark:border-zinc-700">
                        ...
                        <TableBody>
                          {selectedVenue && (
                            <TableRow className="bg-slate-50/70 dark:bg-zinc-700/20">
                              <TableCell className="font-medium text-slate-600 dark:text-zinc-400 pl-6 text-sm">
                        ...
                        <Table>
                          ...
                          <TableBody>
                            {client.payments.map((p) => (
                              <TableRow key={p.id} className="hover:bg-slate-50/80 dark:hover:bg-zinc-700/20 transition-colors">
                        ...
                        <Table>
                          ...
                          <TableBody>
                            {client.vendorPayments.map((vp) => (
                              <TableRow key={vp.id} className="hover:bg-slate-50/80 dark:hover:bg-zinc-700/20 transition-colors">
                                <TableCell className="pl-6 text-sm font-medium text-slate-700 dark:text-zinc-300">
                                  {vendors?.find((v) => v.id === vp.vendorId)?.name ??
                                    `Vendor #${vp.vendorId}`}
                                </TableCell>
                                <TableCell className="text-sm font-semibold text-slate-800 dark:text-zinc-200">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-4 space-y-5">
              <Card className="border border-slate-100 dark:border-zinc-700 shadow-sm">
                  <CardHeader className="pb-3 border-b border-slate-100 dark:border-zinc-700">
                  ...
                  <CardContent className="pt-4">
                    <div className="space-y-4">
                      ...
                      <div className="border-t dark:border-zinc-700 pt-4">
                        ...
                        <div className="flex justify-between font-semibold border-t dark:border-zinc-700 pt-2 mt-2 text-sm">
                          <span>Total</span>
