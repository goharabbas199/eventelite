...
- [Organization tenancy boundary](organization-tenancy.md) — Derive scope from the authenticated server user; child records inherit ownership through validated aggregate-root parents.
